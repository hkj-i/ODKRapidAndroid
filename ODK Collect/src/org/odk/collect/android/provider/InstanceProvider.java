...
/**
 * Change database to add another column that stores a form's displayname
 */
public class InstanceProvider extends ContentProvider {
    ...
    private static class DatabaseHelper extends ODKSQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
           db.execSQL("CREATE TABLE " + INSTANCES_TABLE_NAME + " ("
               ...
               // hee
               + InstanceColumns.JR_FORM_NAME + " text, "
               // ---
           ...
           //    + InstanceColumns.JR_FORM_NAME + " text not null);"); // hee
        }
    ...
    public Uri insert(Uri uri, ContentValues initialValues) {
    	Log.i("InstanceProvider", "form inserted :" + uri.toString());
    ...
    static {
        ...
        sInstancesProjectionMap.put(InstanceColumns.JR_FORM_NAME, InstanceColumns.JR_FORM_NAME);
